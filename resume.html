        ...
        <div class="container gutter-top">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Professor de Educação Profissional em TI</h5>
                                        <span class="timeline__period">2009 — 2018</span>
                                        <p class="timeline__description">
                                            SENAI - Serviço Nacional da Indústria - Arapiraca/AL</p>
                                    </article>

                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Licenciatura em Pedagogia
                                        </h5>
                                        <span class="timeline__period">2012</span>
                                        <p class="timeline__description">Universidade Norte do Paraná</p>
                                    </article>
                    ...
                    <!-- Footer -->
                    <footer class="footer">© J. A. R. Silva</footer>
                </div>
            </div>
        </div>
    </main>
